...
Ce projet est **individuel**, **court** et **cadré**. Il permettra de vérifier que vous avez acquis les compétences suivantes :
...
Reproduisez à l'identique les trois graphiques ci-dessous en complétant le document `belgium_notebook.qmd`. Les données à utiliser ne sont malheureusement pas proposées sous la forme d'un tableau unique. Vous avez à votre disposition six tableaux de données que vous allez devoir recombiner et retravailler afin d'obtenir un tableau unique vous permettant de réaliser les graphiques demandés.
...
Les termes de la licence relative à ces données sont accessibles ici : <https://statbel.fgov.be/sites/default/files/files/opendata/Licence%20open%20data_FR.pdf>
